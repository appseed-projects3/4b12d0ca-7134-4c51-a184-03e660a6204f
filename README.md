...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-21 02:06`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/4b12d0ca-7134-4c51-a184-03e660a6204f.git
$ cd 4b12d0ca-7134-4c51-a184-03e660a6204f
```
